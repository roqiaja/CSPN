        ...
        <section id="homeIntro" class="parallax first-widget">
            <div class="parallax-overlay">
                <div class="container home-intro-content">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Customer Service PAWITRA NETWORK</h2>
                            <p>Pawitra Network merupakan sebuah perusahaan layanan Teknologi Informasi yang berbasis di Sidoarjo sejak tahun 2017.

                            Didirikan dengan loyalitas dan dedikasi dalam memberikan layanan terbaik dan solusi inovatif di bidang IT meliputi Jaringan, Infrastruktur, CCTV, Web, dan Aplikasi.

                            Kami terus berinovasi dalam layanan dan produk kami. Kami selalu menyediakan teknologi terkini yang efisien, aman,  dan sesuai kebutuhan Anda. </p>
                        </div> <!-- /.col-md-12 -->
                    </div> <!-- /.row -->
                </div> <!-- /.container -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="contact-wrapper">
                                <h3>Punya keluhan yang ingin disampaikan ke Pawitra Network?</h3>
